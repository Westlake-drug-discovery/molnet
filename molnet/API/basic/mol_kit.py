...
from .constant import DAY_LIGHT_FG_SMARTS_LIST
...
# thanks to https://github.com/PaddlePaddle/PaddleHelix
class CompoundKit(object):
    ...
    atom_vocab_dict = {
        ...
        'atom_is_in_ring': [0, 1],
        'van_der_waals_radis': [2,3,4,5,'misc'],
    ...
    def get_atom_value(atom, name):
        ...
        if name == 'atomic_num':
            ...
            return CompoundKit.check_partial_charge(atom)
        else:
    ...
    def get_atom_feature_id(atom, name):
        ...
        if name in CompoundKit.atom_float_names:
            return CompoundKit.get_atom_value(atom, name)
